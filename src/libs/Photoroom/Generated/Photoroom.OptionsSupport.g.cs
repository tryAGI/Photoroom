...
namespace Photoroom
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Photoroom.AutoSDKRetryOptions Retry { get; set; } = new global::Photoroom.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Photoroom.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Photoroom.IAutoSDKHook>();
        ...
        public global::Photoroom.AutoSDKClientOptions AddHook(
            global::Photoroom.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Photoroom.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Photoroom.AutoSDKClientOptions UseAuthorizationProvider(
            global::Photoroom.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Photoroom.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Photoroom.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Photoroom.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Photoroom.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Photoroom.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Photoroom.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Photoroom.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Photoroom.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Photoroom.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Photoroom.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Photoroom.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Photoroom.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Photoroom.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Photoroom.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Photoroom.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Photoroom.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Photoroom.AutoSDKClientOptions clientOptions,
            global::Photoroom.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Photoroom.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Photoroom.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Photoroom.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Photoroom.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Photoroom.IAutoSDKHook, global::Photoroom.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Photoroom.AutoSDKHookContext context)
        {
