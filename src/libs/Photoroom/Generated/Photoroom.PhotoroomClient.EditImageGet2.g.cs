...
namespace Photoroom
{
    public partial class PhotoroomClient
    {
        ...
        private static readonly global::Photoroom.AutoSDKServer[] s_EditImageGet2Servers = new global::Photoroom.AutoSDKServer[]
                ...
                else
                {
                    await global::Photoroom.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Photoroom.EditImageGetResponse? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Photoroom.EditImageGetResponse.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Photoroom.ApiException<global::Photoroom.EditImageGetResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 402)
                            {
                                ...
                                global::Photoroom.EditImageGetResponse2? __value_402 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_402 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_402 = global::Photoroom.EditImageGetResponse2.FromJson(__content_402, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_402 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Photoroom.ApiException<global::Photoroom.EditImageGetResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                global::Photoroom.EditImageGetResponse3? __value_500 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_500 = global::Photoroom.EditImageGetResponse3.FromJson(__content_500, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Photoroom.ApiException<global::Photoroom.EditImageGetResponse3>.Create(
                                    statusCode: __response.StatusCode,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Photoroom.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Photoroom.AutoSDKHttpResponse<byte[]>> EditImageGet2AsResponseAsync(
            string templateId,
            string? apiKey = default,
            string? imageUrl = default,
            string? conceptUrl = default,
