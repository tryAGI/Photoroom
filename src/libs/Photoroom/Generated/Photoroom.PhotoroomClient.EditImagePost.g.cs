...
namespace Photoroom
{
    public partial class PhotoroomClient
    {
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.BeautifyOnSubjectMismatch != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.BeautifyOnSubjectMismatch ?? string.Empty),
                                    name: "\"beautify.onSubjectMismatch\"");
                            ...
                            if (request.IroningMode != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.IroningMode ?? string.Empty),
                                    name: "\"ironing.mode\"");
        ...
        public async global::System.Threading.Tasks.Task<byte[]> EditImagePostAsync(
            ...
            string? beautifyOnSubjectMismatch = default,
