...
namespace Photoroom
{
    public partial class PhotoroomClient
    {
        ...
        private static readonly global::Photoroom.AutoSDKServer[] s_EditImagePostServers = new global::Photoroom.AutoSDKServer[]
        ...
        private static readonly global::Photoroom.EndPointSecurityRequirement s_EditImagePostSecurityRequirement0 =
        ...
        private static readonly global::Photoroom.EndPointSecurityRequirement[] s_EditImagePostSecurityRequirements =
            new global::Photoroom.EndPointSecurityRequirement[]
            {                s_EditImagePostSecurityRequirement0,
            };
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Photoroom.EditImagePostRequest
            {
                ...
                EditWithAIAdditionalImages_key_ImageFile = editWithAIAdditionalImages_key_ImageFile,
                EditWithAIAdditionalImages_key_ImageFilename = editWithAIAdditionalImages_key_ImageFilename,
        ...
        public async global::System.Threading.Tasks.Task<byte[]> EditImagePostAsync(
            ...
            string? backgroundColor = default,
            object? backgroundExpandPrompt = default,
            global::System.IO.Stream? backgroundGuidanceImageFile = default,
            string? backgroundGuidanceImageFilename = default,
            double? backgroundGuidanceScale = default,
            global::System.IO.Stream? backgroundImageFile = default,
            string? backgroundImageFilename = default,
            string? backgroundNegativePrompt = default,
            string? backgroundPrompt = default,
            string? backgroundScaling = default,
            ...
            string? describeAnyChangePrompt = default,
            double? describeAnyChangeSeed = default,
            global::System.IO.Stream? editWithAIAdditionalImages_key_ImageFile = default,
            string? editWithAIAdditionalImages_key_ImageFilename = default,
            string? editWithAIMode = default,
            string? editWithAIPrompt = default,
            double? editWithAISeed = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Photoroom.EditImagePostRequest
            {
                BackgroundBlurMode = backgroundBlurMode,
                BackgroundBlurRadius = backgroundBlurRadius,
                BackgroundColor = backgroundColor,
                BackgroundExpandPrompt = backgroundExpandPrompt,
                BackgroundGuidanceImageFile = global::System.Array.Empty<byte>(),
                BackgroundGuidanceImageFilename = backgroundGuidanceImageFilename,
                BackgroundGuidanceScale = backgroundGuidanceScale,
                BackgroundImageFile = global::System.Array.Empty<byte>(),
                BackgroundImageFilename = backgroundImageFilename,
                BackgroundNegativePrompt = backgroundNegativePrompt,
                BackgroundPrompt = backgroundPrompt,
                BackgroundScaling = backgroundScaling,
                ...
                DescribeAnyChangePrompt = describeAnyChangePrompt,
                DescribeAnyChangeSeed = describeAnyChangeSeed,
                EditWithAIAdditionalImages_key_ImageFile = global::System.Array.Empty<byte>(),
                EditWithAIAdditionalImages_key_ImageFilename = editWithAIAdditionalImages_key_ImageFilename,
                EditWithAIMode = editWithAIMode,
                EditWithAIPrompt = editWithAIPrompt,
                EditWithAISeed = editWithAISeed,
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (backgroundGuidanceImageFile != default)
                            {

                                var __contentBackgroundGuidanceImageFile = new global::System.Net.Http.StreamContent(backgroundGuidanceImageFile);
                                __contentBackgroundGuidanceImageFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.BackgroundGuidanceImageFilename is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.BackgroundGuidanceImageFilename) ?? string.Empty).ToLowerInvariant() switch
                            ...
                            if (backgroundImageFile != default)
                            {

                                var __contentBackgroundImageFile = new global::System.Net.Http.StreamContent(backgroundImageFile);
                                __contentBackgroundImageFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.BackgroundImageFilename is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.BackgroundImageFilename) ?? string.Empty).ToLowerInvariant() switch
                            ...
                            if (editWithAIAdditionalImages_key_ImageFile != default)
                            {

                                var __contentEditWithAIAdditionalImages_key_ImageFile = new global::System.Net.Http.StreamContent(editWithAIAdditionalImages_key_ImageFile);
                                __contentEditWithAIAdditionalImages_key_ImageFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.EditWithAIAdditionalImages_key_ImageFilename is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.EditWithAIAdditionalImages_key_ImageFilename) ?? string.Empty).ToLowerInvariant() switch
